...
<head>
    ...
    <title>NaTa Bootstrap Template - About</title>
    ...
    <!-- =======================================================
  * Template Name: NaTa - v1.3.0
  * Template URL: https://bootstrapmade.com/NaTa-bootstrap-construction-website-template/
...
<body>
        ...
        <div class="container-fluid container-xl d-flex align-items-center justify-content-between">
            ...
            <nav id="navbar" class="navbar">
                <ul>
                    ...
                    <li class="dropdown"><a href="#"><span>Passager</span> <i
                                class="bi bi-chevron-down dropdown-indicator"></i></a>
                        <ul>
                            <li><a href="#">Comment ça marche</a></li>
                            <li><a href="#">Nos Prix & Engagement</a></li>
                        </ul>
                    </li>
        ...
        <section id="alt-services-2" class="alt-services section-bg">
            <div class="container" data-aos="fade-up">
                ...
                <div class="row justify-content-around gy-4">
                    ...
                    <div class="col-lg-6 img-bg" style="background-image: url(img/alt-services-2.jpg);"
                        data-aos="zoom-in" data-aos-delay="100"></div>
                </div>
    ...
    <footer id="footer" class="footer">
        ...
        <div class="footer-legal text-center position-relative">
            <div class="container">
                <div class="copyright">
                    &copy; Copyright <strong><span>NaTa</span></strong>. All Rights Reserved
                </div>
                <div class="credits">
                    <!-- All the links in the footer should remain intact. -->
                    <!-- You can delete the links only if you purchased the pro version. -->
                    <!-- Licensing information: https://bootstrapmade.com/license/ -->
                    <!-- Purchase the pro version with working PHP/AJAX contact form: https://bootstrapmade.com/NaTa-bootstrap-construction-website-template/ -->
